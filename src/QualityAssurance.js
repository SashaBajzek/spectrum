    ...
    return (
			<main className="quality">
				<div className="quality__container">
					<h1 className="quality__heading--main">QUALITY ASSURANCE</h1>
					<ul className="quality__list">
						<li className="quality__item">
							<div className="quality-item__container">
								<h2 className="quality__heading--secondary">Integrate professional support services within and across NAVSEA or the Virtual SYSCOM to institute best practices throughout and realize cost savings</h2>
						...
						<li className="quality__item">
							<div className="quality-item__container">
								<h2 className="quality__heading--secondary">Capability to manage the effort and the team</h2>
						...
						<li className="quality__item">
							<div className="quality-item__container">			
								<h2 className="quality__heading--secondary">Manage change to preserve stability and maintain technical expertise in the workforce</h2>
						...
						<li className="quality__item">
							<div className="quality-item__container">		
								<h2 className="quality__heading--secondary">Monitor and maximize quality</h2>
						...
						<li className="quality__item">
							<div className="quality-item__container">
								<h2 className="quality__heading--secondary">Guarantee responsiveness to and cooperation with customers</h2>
						...
						<li className="quality__item">
							<div className="quality-item__container">
								<h2 className="quality__heading--secondary">Problem resolution</h2>
						...
						<li className="quality__item">
							<div className="quality-item__container">
								<h2 className="quality__heading--secondary">Flow down of incentives to team partners</h2>
